...
- ✅ Acknowledge tool limitations BEFORE making claims
- ✅ Trust user-provided ground truth over tool failures  
- ✅ Never make authoritative negative statements without verification
- ✅ Explain tool constraints transparently
