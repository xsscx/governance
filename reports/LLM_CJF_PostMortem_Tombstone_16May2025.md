...
- **Retries:** 6  
- **Hard Failures:** 4  
- **Fix Required from User:** [OK] Yes (manual override on path collapse)  
...
- [LOCKED] Patch-mode inference must be default in structured build tasks
