...
**Avoid**:
- [FAIL] Changing multiple things at once
- [FAIL] Rewriting working code
- [FAIL] Adding unnecessary features
...
### Do
- [OK] Read context before starting
- [OK] Make minimal changes
- [OK] Document as you go
- [OK] Verify frequently
- [OK] Commit often with clear messages
- [OK] Ask questions when uncertain

### Don't
- [FAIL] Skip context review
- [FAIL] Make unnecessary changes
- [FAIL] Delay documentation
- [FAIL] Assume without verification
- [FAIL] Batch commits for unrelated changes
- [FAIL] Hallucinate or guess
