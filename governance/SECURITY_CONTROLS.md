...
**Requirements**:
1. [OK] All workflows reviewed before merge
2. [OK] No secrets in workflow files
3. [OK] Pin action versions (not @master)
4. [OK] Limit workflow permissions
5. [OK] Review all third-party actions
...
**Security Controls**:
1. [OK] Build in isolated Docker containers
2. [OK] No network access during fuzzing
3. [OK] Resource limits enforced
4. [OK] Crash artifacts sanitized before upload
5. [OK] Corpus data version controlled
...
**Requirements**:
1. [OK] Sanitize before storage
2. [OK] No PII in crash files
3. [OK] Verify file sizes (no OOMs stored)
4. [OK] Checksum verification
5. [OK] Retention limits (90 days)
...
if git diff --cached --stat | grep -E '[0-9]{4,}\s+insertions'; then
  echo "[WARN]  WARNING: Large changes detected - review carefully"
fi
...
- `docs/AST_Gates_Checks.md` - Mandatory validation gates for security fixes
